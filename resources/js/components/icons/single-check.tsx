// components/icons/SingleCheck.tsx
...
const SingleCheck: React.FC<SingleCheckProps> = ({ className = '', size = 14, color = 'currentColor' }) => {
    return (
        <svg viewBox="0 0 14 14" height={size} width={size} className={className} fill="none">
            <path
